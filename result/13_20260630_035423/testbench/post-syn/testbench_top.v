...
module testbench_top;
    ...
    reg clear_acc;
    reg pulse_en;
    reg [7:0] a_sram_rdata;
    reg [127:0] b_sram_rdata0;
    reg [127:0] b_sram_rdata1;
`ifdef GATE
    ...
    task drive_inputs;
        ...
        begin
            for (row = 0; row < ROWS; row = row + 1) begin
                ...
                a_sram_rdata = a_tmp[7:0];
            end
            for (col = 0; col < COLS; col = col + 1) begin
                b_tmp = b_value(col, k_i);
                if (col < 16) begin
                    b_sram_rdata0[(15-col)*8 +: 8] = b_tmp[7:0];
                end else begin
                    b_sram_rdata1[(31-col)*8 +: 8] = b_tmp[7:0];
                end
            end
        end
    endtask
...
`endif
    ...
    initial begin
        ...
        errors = 0;
        a_sram_rdata = 8'd0;
        b_sram_rdata0 = 128'd0;
        b_sram_rdata1 = 128'd0;
